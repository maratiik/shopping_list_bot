...
def confirm_deleting_all() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()

    builder.row(InlineKeyboardButton(
        text=texts.CONFIRM_DELETING_ALL_TEXT,
        callback_data=texts.CONFIRM_DELETING_ALL_CB
    ))
